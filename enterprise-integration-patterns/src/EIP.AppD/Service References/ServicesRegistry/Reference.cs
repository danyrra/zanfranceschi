...
namespace EIP.AppD.ServicesRegistry {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(EIP.AppD.ServicesRegistry.EventService))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(EIP.AppD.ServicesRegistry.RequestService))]
    ...
    [System.SerializableAttribute()]
    public partial class EventService : EIP.AppD.ServicesRegistry.Service {
    ...
    [System.SerializableAttribute()]
    public partial class RequestService : EIP.AppD.ServicesRegistry.Service {
    ...
    public interface IServiceRegistry {
        ...
        string Create(EIP.AppD.ServicesRegistry.Service service);
        ...
        EIP.AppD.ServicesRegistry.EventService[] GetAllEventServices();
        ...
        EIP.AppD.ServicesRegistry.RequestService[] GetAllRequestServices();
        ...
        EIP.AppD.ServicesRegistry.Service GetById(string id);
        ...
        EIP.AppD.ServicesRegistry.EventService FindOneByDataType(string dataTypeFullName);
        ...
        EIP.AppD.ServicesRegistry.Service[] Search(string term);
        ...
        void Update(EIP.AppD.ServicesRegistry.Service service);
    ...
    public partial class ServiceRegistryClient : System.ServiceModel.ClientBase<EIP.AppD.ServicesRegistry.IServiceRegistry>, EIP.AppD.ServicesRegistry.IServiceRegistry {
        ...
        public string Create(EIP.AppD.ServicesRegistry.Service service) {
        ...
        public EIP.AppD.ServicesRegistry.EventService[] GetAllEventServices() {
            return base.Channel.GetAllEventServices();
        }
        
        public EIP.AppD.ServicesRegistry.RequestService[] GetAllRequestServices() {
            return base.Channel.GetAllRequestServices();
        }
        
        public EIP.AppD.ServicesRegistry.Service GetById(string id) {
            return base.Channel.GetById(id);
        }
        
        public EIP.AppD.ServicesRegistry.EventService FindOneByDataType(string dataTypeFullName) {
        ...
        public EIP.AppD.ServicesRegistry.Service[] Search(string term) {
            return base.Channel.Search(term);
        }
        
        public void Update(EIP.AppD.ServicesRegistry.Service service) {
